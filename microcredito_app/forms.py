...
class ClienteForm(forms.ModelForm):
    ...
    def clean_bi_passaporte(self):
        ...
        if bi:
            ...
            elif re.match(r'^[0-9]{8}[A-Z]$', bi):
                pass
            # Passaporte: 2 letras + 7 dígitos
            elif re.match(r'^[A-Z]{2}[0-9]{7}$', bi):
                pass
            else:
                raise ValidationError('Formato inválido. Use BI (12 dígitos + letra), DIRE (8 dígitos + letra) ou Passaporte (2 letras + 7 dígitos)')
