...
urlpatterns = [
    ...
    #path('emprestimo/baixar/<int:id>/', views.emprestimo_baixar, name='emprestimo_baixar'),
    #path('emprestimos/baixar/<int:parcela_id>/', views.baixar_parcela, name='baixar_parcela'),
    ...
    # Firebase FCM - Registro de dispositivos
    # ✅ CORRETO (escrito com "c" - devices)
